<template>
  <div>
    ...
    <div class="text-center">
      Click on a sector to see the top 5 partner of North and Central Asia in
      each sector
    </div>
    <div
...
const showDetailBack = (eco, item) => {
  ...
  let datay = [45240, 42731, 29140, 24642, 18065];
...
const showDetailForward = (eco, item) => {
  isShowGraphForward.value = true;
  let setColor = ["#E41A1C", "#377EB8", "#4DAF4A", "#FF7F00", "#984EA3"];
  let datax = ["CHN", "JPN", "USA", "KOR", "TWN"];
  let dataxFullName = [
    "China",
    "Japan",
    "United States",
  ...
  let datay = [22258, 20881, 16016, 15914, 8088];
