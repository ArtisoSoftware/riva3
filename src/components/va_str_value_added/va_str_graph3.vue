  ...
  <div>
    <div v-show="!showData" class="text-center text-h5">
      <div class="text-black q-pt-md">
        <b
          >How are {{ groupName }} economies's exports of
          {{ dataSend.sectorName }} to {{ dataSend.importingName }} produced and
          utilised?</b
        >
      </div>
  ...
  setTimeout(() => {
    Highcharts.chart("container3", {
      ...
      title: {
        ...
        text: `How are ${groupName.value} economies’ exports of ${dataInput.value.sectorName} to ${dataInput.value.importingName} produced and utilised?`,
      },
      xAxis: {
        labels: {
          rotation: -90,
