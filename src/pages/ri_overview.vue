    ...
    <div class="mainApp">
      ...
      <div>
        ...
        <div class="row q-px-md">
          ...
          <div v-if="dimCI.length && dimSI.length" style="width: 600px">
...
const tileSI = ref([]);
const tileCI = ref([]);
const ecoName = ref("Asia-Pacific");
...
const loadDimCal = async () => {
  ...
  const url = serverData.value + "ri/overview_dim_chart.php";
